...
urlpatterns = patterns ('',
    ...
    url(r'^users-current-lendings/(?P<user_id>\w+)/$', UsersCurrentLendings.as_view(), name="users-current-lendings"),
    url(r'^users-past-lendings/(?P<user_id>\w+)/$', UsersLendings.as_view(), name="users-past-lendings"),
