...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lending.start_date'
        db.alter_column(u'lending_lending', 'start_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Lending.start_date'
        db.alter_column(u'lending_lending', 'start_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        u'lending.bookitem': {
            ...
            'book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'book_items'", 'to': u"orm['library.Book']"}),
        ...
        u'lending.lending': {
            ...
            'book_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'book_item'", 'to': u"orm['lending.BookItem']"}),
