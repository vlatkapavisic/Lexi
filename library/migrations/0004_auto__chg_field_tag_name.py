...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'library_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Tag.name'
        db.alter_column(u'library_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
