...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'library_book', 'language', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Book.language'
        db.alter_column(u'library_book', 'language', self.gf('django.db.models.fields.CharField')(max_length=2))
